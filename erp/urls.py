...
urlpatterns = [
    ...
    path("activities/export/", views.daily_activity_export, name="daily_activity_export"),
    path("activities/<int:pk>/update/", views.daily_activity_update, name="daily_activity_update"),
